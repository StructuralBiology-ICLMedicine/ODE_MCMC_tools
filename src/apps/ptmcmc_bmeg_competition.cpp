...
int main(int argc, char **argv){
    ...
    opt_mgr.register_option("proposal:max_adapt_step", (unsigned long)(std::numeric_limits< unsigned long>::max()), "max adapt step" );
	...
	if (!use_AM){
		...
		ram_move_functor->max_adapt_step = opt_mgr.get_option_value<unsigned long>("proposal:max_adapt_step");//1000;
