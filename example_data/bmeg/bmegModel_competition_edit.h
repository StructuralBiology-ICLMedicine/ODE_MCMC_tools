...
#define N_ARRAY_SIZE_Y  6	//4	// number of assigned elements
#define N_ARRAY_SIZE_XC 20	// number of x concentration
#define N_ARRAY_SIZE_PC 0	// number of p concentration
#define N_ARRAY_SIZE_YC 6	//4	// number of y concentration
#define N_ARRAY_SIZE_DX 20	// number of ODEs 
#define N_ARRAY_SIZE_CT 6	//4	// number of conserved totals
...
const char* y_names[] = {"Mat_GFP", "RNAP_prom_RFP", "RNAP_prom_RFP_elong", "prom_GFP", "mRNA_GFP_sum", "mRNA_RFP_sum",  "" };
...
const char* pc_names[] = { "" };
const char* yc_names[] = {"Mat_GFP", "RNAP_prom_RFP", "RNAP_prom_RFP_elong", "prom_GFP", "mRNA_GFP_sum", "mRNA_RFP_sum",  "" };
...
const char* ct_names[] = {"CT Mat_GFP", "CT RNAP_prom_RFP", "CT RNAP_prom_RFP_elong", "CT prom_GFP", "CT mRNA_GFP_sum", "CT mRNA_RFP_sum",  "" };
#endif // NAME_ARRAYS
...
ct[4] = 0; // manual add conserved total for mRNA_GFP_sum
ct[5] = 0; // manual add conserved total for mRNA_RFP_sum
...
y[4] = ct[4] + x[6] + x[19]; // manual add - sum of mRNA_GFP and Ribo_mRNA_GFP
y[5] = ct[5] + x[4] + x[14]; // manual add - sum of mRNA_RFP and Ribo_mRNA_RFP
...
y_c[4] = y[4]/p[0];	// manual edit
y_c[5] = y[5]/p[0];     // manual edit
#endif /* ASSIGNMENT */
