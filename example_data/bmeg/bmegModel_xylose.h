...
#define N_ARRAY_SIZE_Y  3	// number of assigned elements
...
const char* y_names[] = {"Mat_GFP", "RNAP_prom_GFP_elong", "RNAP_prom_GFP",  "" };
const char* xc_names[] = {"NMP", "NTP", "AA", "mRNA_GFP", "Ribo", "prom_GFP", "Ribo_mRNA_GFP_elong", "GFP", "IInd_nrg_src", "RNAP", "Ribo_mRNA_GFP",  "" };
const char* pc_names[] = { "" };
const char* yc_names[] = {"Mat_GFP", "RNAP_prom_GFP_elong", "RNAP_prom_GFP",  "" };
...
const char* ct_names[] = {"CT Mat_GFP", "CT RNAP_prom_GFP_elong", "CT RNAP_prom_GFP",  "" };
#endif // NAME_ARRAYS
...
y[2] = ct[2]-x[5];	//metabolite 'RNAP_prom_GFP': reactions
