...
const char* y_names[] = {"NTP_waste_track", "prom_GFP", "Mat_GFP", "prom_RFP", "RNAP_prom_GFP_elong", "AA", "Mat_RFP",  "" };
...
const char* pc_names[] = { "" };
const char* yc_names[] = {"NTP_waste_track", "prom_GFP", "Mat_GFP", "prom_RFP", "RNAP_prom_GFP_elong", "AA", "Mat_RFP",  "" };
...
const char* ct_names[] = {"CT NTP_waste_track", "CT prom_GFP", "CT Mat_GFP", "CT prom_RFP", "CT RNAP_prom_GFP_elong", "CT AA", "CT Mat_RFP",  "" };
#endif // NAME_ARRAYS
